...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DisciplineOS — The AI Operating System for Discipline" },
      {
        name: "description",
        content:
          "Master your discipline with an AI-powered operating system for habits, focus, and long-term consistency.",
      },
      { name: "theme-color", content: "#090909" },
      { property: "og:title", content: "DisciplineOS — Master Your Discipline" },
      {
