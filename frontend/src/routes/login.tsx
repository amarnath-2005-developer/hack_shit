...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in to your DisciplineOS account." },
    ],
  }),
  component: () => (
    <AuthProvider>
  ...
  return (
    <div className="relative min-h-screen bg-[#090909] text-foreground overflow-hidden flex items-center justify-center px-4 py-16">
      ...
      >
        ...
        <div className="glass-strong rounded-3xl p-8 shadow-[0_40px_120px_-30px_rgba(139,92,246,0.4)]">
          <h1 className="text-2xl font-semibold tracking-tight">Welcome back</h1>
          <p className="mt-1.5 text-sm text-muted-foreground">
            Sign in to continue building your streak.
          </p>
